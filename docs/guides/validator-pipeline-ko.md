...
```text
codex exec --json --output-schema docs/schemas/validator-result.schema.json --output-last-message tasks/handoffs/TASK-{ID}/validator-a-last-message-{N}.json --ephemeral -s read-only -a never -C . -
```
