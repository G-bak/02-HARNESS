...
| 구분 | 기준 |
|---|---|
| 기본 실행 | Analyst가 같은 작업 세션 안에서 조사 범위를 분리해 수행하고 Research Summary JSON을 작성한다. |
...
| 최신 외부 기술 사실 확인 | Researcher 역할로 좁은 질문을 만들고 공식 문서/1차 출처를 우선 확인한다. |
