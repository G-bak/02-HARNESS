...
| 조사 유형 | 도구 | 모델 |
|---|---|---|
| 코드 내부 조사 (코드베이스 읽기, 레포 탐색, 기존 구조 이해) | Claude Code Agent tool | — |
| 외부 기술 조사 (최신 기술, 비교 분석, 아이디어, 보고서) | Codex CLI (Bash) | `gpt-5.4` (`gpt-5.3-codex` 사용 금지) |
