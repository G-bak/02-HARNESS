...
```json
{
  ...
  "total_score": 97,
  "grade": "S",
  "improvement_notes": "재시도 없이 완료. 보고서와 Slack 알림에 report_path 포함."
}
```
...
{
  "task_id": "TASK-20260426-003",
  "scored_by": "Validator-A | Validator-B | Analyst",
  "outcome_score": 57,
  "process_score": 37,
  "total_score": 94,
  "grade": "S",
  "improvement_notes": "Research Summary를 더 압축하면 컨텍스트 최소화 점수를 높일 수 있음."
}
```
